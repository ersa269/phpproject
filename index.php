					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="bog.html">Blog</a></li>
									<li class="nav-item"><a class="nav-link" href="customer.php">Customer Details</a></li>
								</ul>
							</li>
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="nav-item">
								<h6 class="text-dark"><?php echo $name ?></h6>
							</li>
						</ul>
					</div>
				</div>
	...
	<section class="owl-carousel active-product-area section_gap">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<?php
				$query=mysqli_query($con,"select *from cartegory ");
				while($row1=mysqli_fetch_array($query))
				{
				?>
<a href="show.php?catid=<?php echo $row1["Cat_Id"];?>"><input type="submit" value="<?php  echo $row1["Cat_Name"] ?>" class="btn btn-warning"></a>
<?php
				}
				?>
				<div class="row">
					<!-- single product -->
				<?php
				$query=mysqli_query($con,"select *from form where Cat_id=1");
