...
?>
<li class="nav-item">
    <h6 class="text-dark"><?php echo $row["Name"] ?></h6>
    <h6 class="text-dark"><?php echo $row["Email"] ?></h6>
    <h6 class="text-dark"><?php echo $row["Pass"] ?></h6>
    <input type="text" disabled value="<?php echo $name ?>" name="name">
