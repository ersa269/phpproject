...
$query=mysqli_query($con,"insert into users(Name,Email,Pass) values('$name','$email','$pass')");
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form"  method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="Save" class="primary-btn">Signup</button>
